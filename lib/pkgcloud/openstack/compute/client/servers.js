 ...
 * @param {Object}          [details.blockDeviceMapping] optional block device mapping
 * @param {String}          [details.userData] optional base64 encoded user data scripts
 * @param callback
 * @returns {request|*}
 */
exports.createServer = function createServer(details, callback) {
  ...
  if (details.blockDeviceMapping) {
    createOptions.body.server.block_device_mapping = details.blockDeviceMapping;
  }
